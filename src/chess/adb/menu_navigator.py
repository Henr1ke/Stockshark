...
class MenuNavigator:
    ...
    def vs_player(self, name: str, is_white: Optional[bool] = None, duration: Optional[int] = None) -> None:
        ...
        self.__tap_screen(*self.__coordinates.player_color_coords(is_white))  # choose color
    ...
    def vs_computer(self, diff_lvl: int, is_white: Optional[bool] = None) -> None:
        ...
        self.__tap_screen(*self.__coordinates.computer_color_coords(is_white))  # choose color
