...
class Piece(ABC):
    ...
    def _gen_slider_positions(self, game, start_pos: Position, is_diag: bool) -> List[Position]:
        possible_pos = []
        ...
        for direction in directions:
            try:
                ...
                while game[end_pos] is None:
                    possible_pos.append(end_pos)
                    end_pos += direction

                if game[end_pos].is_white is not self.is_white:
                    possible_pos.append(end_pos)
    ...
    def _gen_inc_positions(self, game, start_pos: Position, incs: List[Tuple[int, int]]) -> List[Position]:
        possible_pos = []
