...
class AgentMinMax(Agent):
    ...
    def minmax(self, curr_depth: int, max_depth: int, game: GameEngine) -> Tuple[float, Move]:
        moves = []
    ...
    def minmax_ab(self, curr_depth: int, max_depth: int, game: GameEngine, alpha: float = -math.inf,
    ...
    def minmax_ab_sorted(self, curr_depth: int, max_depth: int, game: GameEngine, alpha: float = -math.inf,
                         beta: float = math.inf) -> Tuple[float, Move]:
        # moves = game.legal_moves
        moves = []
        pieces_tiles = game.get_available_pieces_tiles()
...
if __name__ == '__main__':
    game = GameEngine("1r2r1k1/5ppp/8/q1b3n1/3P3P/2P2BP1/PPN2P2/3KQ2R w - - 0 1")
